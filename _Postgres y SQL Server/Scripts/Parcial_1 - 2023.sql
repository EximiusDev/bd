...
-- ALTER TABLE Ejercicio_2.profesor ADD CONSTRAINT pk_profesor PRIMARY KEY(nro_legajo);
-- ALTER TABLE Ejercicio_2.profesor ADD CONSTRAINT fk_profesor_persona FOREIGN KEY (tipo,  numero) REFERENCES Ejercicio_2.persona(tipo, numero);
...
-- Agregar constraint (CHECK y FOREIGN KEY)
...
-- Segundo crear la constraint en persona (fk de localidad)
BEGIN TRANSACTION;
...
UPDATE Ejercicio_3.persona per
SET codigo_pais = loc.codigo_pais, 
	codigo_provincia = loc.codigo_provincia, 
	codigo_localidad = loc.  codigo_localidad
 from Ejercicio_3.localidad loc
	WHERE per. codigo_postal = loc. codigo_postal;
...
SET codigo_pais = loc. codigo_pais, 
	codigo_provincia = loc. codigo_provincia,
	codigo_localidad =  loc. codigo_localidad
 WHERE codigo_postal = (select loc.codigo_postal from Ejercicio_3.localidad loc where per.codigo_postal = loc.codigo_postal);
*/
 /*
...
-- Quinto: eliminar la columna de codigo postal de persona
BEGIN TRANSACTION;
