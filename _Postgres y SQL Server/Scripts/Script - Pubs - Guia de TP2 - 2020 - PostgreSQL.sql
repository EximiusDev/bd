...
/*
En PostgreSQL, las columnas con valores autoincrementales se definen 
especificando un tipo de dato especial llamado SERIAL: 
...
"proveed_codprov_seq" for serial column "proveed2.codprov" 
 
Tal como indica el mensaje devuelto, PostgreSQL crea una secuencia 
implícita para la columna definida con el tipo de dato SERIAL. 
...
------------------------- Usuario actual 
/*
En PostgreSQL la función current_user retorna el nombre del usuario 
actual. Las funciones user y session_user retornan la misma 
información. 
 */
SELECT USER;
SELECT current_user;
